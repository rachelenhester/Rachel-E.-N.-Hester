...
I am currently a TA for BIO2350, Human Physiology, and a Graduate Student Assistant at the CPP Vivarium.\
...
Current Animal Keeper Volunteer at the OC Zoo.

![](images/clipboard-459302564.png){style=".caption{    text-align: center; }" fig-align="center" width="219"}

#### At the Vivarium with one of my lizards {style="text-align: center"}
...
![](images/BatBoxMe.jpg){style=".caption{    text-align: center; }" fig-align="center" width="288"}

#### Bat Box Construction {style="text-align: center"}
